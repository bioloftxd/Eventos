...
namespace Eventos.IO.Domain.Eventos.Commands
{
        ...
        IHandler<AtualizarEnderecoEventoCommand>
    {
        ...
        public EventoCommandHandler(IEventoRepository eventoRepository,
            IUnitOfWork uow,
            IBus bus,
            IDomainNotificationHandler<DomainNotification> notifications, IUser user) : base(uow, bus, notifications)
        {
        ...
        public void Handle(RegistrarEventoCommand message)
        {
            ...
            var evento = Evento.EventoFactory.NovoEventoCompleto(
                message.Id, message.Nome, message.DescricaoCurta,
                message.DescricaoLonga,message.DataInicio,
                message.DataFim, message.Gratuito,
                message.Valor,message.Online,
        ...
        public void Handle(AtualizarEventoCommand message)
        {
            ...
            var evento = Evento.EventoFactory.NovoEventoCompleto(
                ...
                message.Valor, message.Online,
                message.NomeEmpresa, message.OrganizadorId,
                eventoAtual.Endereco, message.CategoriaId);
